...
<div class="signup-form">
    <form action="/registration" method="post">
        ...
        <div class="form-group">
			<div class="input-group">
				...
				<input type="text" class="form-control" name="Mobile1" placeholder="Enter Your AlterNative Mobile Number" required="required">
			</div>
        </div>
        <div class="form-group">
	...
	<div class="text-center" style="margin-top: -100px; color:#5f2424">Already have an account? <a href="#myModal" class="trigger-btn" style="color:#f68416" data-toggle="modal">Login here</a></div>
